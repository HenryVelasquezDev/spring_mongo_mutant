...
public class EstadisticasMutanteDTO {
	
	private Integer count_mutant_dna;
	private Integer count_human_dna;
	private Double ratio;
	
	public EstadisticasMutanteDTO(Integer count_mutant_dna, Integer count_human_dna) {
		super();
		this.count_mutant_dna = count_mutant_dna;
		this.count_human_dna = count_human_dna;
		this.ratio = Double.valueOf(this.count_mutant_dna) / Double.valueOf(this.count_human_dna);
	}
